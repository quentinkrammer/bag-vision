...
const openLargeModalButton = document.getElementById("open-large-modal-button");

imageElements.forEach((imageElement) =>
  imageElement.addEventListener("click", onOpenSmallModal)
);
smallModalCloseButton.addEventListener("click", () => smallModal.hidePopover());
openLargeModalButton.addEventListener("click", onOpenLargeModal);
largeModalCloseButton.addEventListener("click", () => largeModal.hidePopover());
